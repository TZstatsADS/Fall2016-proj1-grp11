```{r}
data1 <- read.csv("~/Desktop/G5243/project1/personal data/2014 all person/ss14pusa.csv")
data2 <- read.csv("~/Desktop/G5243/project1/personal data/2014 all person/ss14pusb.csv")
d1 <- cbind(data1$SERIALNO,data1$ST,data1$SEX,data1$AGEP,
            data1$SCHL,data1$FOD1P,data1$FOD2P,data1$WKHP,
            data1$WAGP,data1$ESR,data1$PINCP,data1$PERNP,
            data1$JWMNP)
d2 <- cbind(data2$SERIALNO,data2$ST,data2$SEX,data2$AGEP,
            data2$SCHL,data2$FOD1P,data2$FOD2P,data2$WKHP,
            data2$WAGP,data2$ESR,data2$PINCP,data2$PERNP,
            data2$JWMNP)
