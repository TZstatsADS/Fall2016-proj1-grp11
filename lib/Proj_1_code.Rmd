...
------------- | -------------
SERIALNO      | Unique code for person
ST            | State Code
SEX           | Gender
AGEP          | Age
SCHL          | Educational Attainment
FOD1P         | Field of Degree - First Entry
FOD1P         | Field of Degree - Second Entry
WKHP          | Hours Worked per Week
ESR           | Employment Status Recode
PINCP         | Total Person's Income
PERCP         | Total Person's Earning
...
Proj_1a<-cbind(Origdata1$SERIALNO,Origdata1$ST,Origdata1$SEX,
               ...
               Origdata1$WKHP,Origdata1$ESR,Origdata1$PINCP,Origdata1$PERNP)
...
Proj_1b<-cbind(Origdata2$SERIALNO,Origdata2$ST,Origdata2$SEX,
               ...
               Origdata2$WKHP,Origdata2$ESR,Origdata2$PINCP,Origdata2$PERNP)
