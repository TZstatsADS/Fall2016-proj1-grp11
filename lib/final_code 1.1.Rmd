...
Money is a useful tool in anyplace at anytime. And the most important factors connected to money might be person's income and unemployment rate. Is there any unfairness among these two? If there is, how can we improve the situation? 

1.	What factors have influence on income? Does any unfair situation exist in different kind of people's income?
2.	Does unfairness exist in unemployment rate? 


## Introduction:

Firstly, we use 2014 ACS 1-year personal data to construct multiple graphs to show the distribution of income according to several factors. Then we build a model to display the unemployment rate's distribution in US. During these two steps, we choose several factors to carry out different survey in different aspects. In the end, we find out that unfairness do exist in both income and unemployment rate and we suggest that some appropriate changes in state policy might ameliorate this situation.
...
## Conclusion:
  ...
  Generally, inequity exists in income and unemployment rate which influence our life a lot. If you want to have a better life, you have to consider a series of problems. Like changing your gender if you do not have a great degree (just a joke). Or maybe you can choose middle states in US to live in. On the government side, some policies changes like adjustment of tax and subsidy should also be helpful.
